...
- **Security & Integrity:**
  - Authorization enforced strictly by numeric Telegram User IDs (`ADMIN_ID`).
...
│   ├── services/
│   │   ├── appointment_service.py # Appointment business logic & stats
│   │   └── user_service.py    # User registration logic
│   ├── states/
...
ADMIN_ID=987654321
DB_URL=sqlite+aiosqlite:///gt_beauty.db
```
